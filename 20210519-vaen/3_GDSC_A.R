...
save(all.mat, all.sample.size, all.in_sample_R2.mat, all.avg_CV_R2.mat, all.F1_R2.mat, file = "./Output/3/GDSC.A.info.RData")
...
write.table(TCGA.pred.mat, file = "./Output/3/VAEN_GDSC.A.pred_TCGA.txt", quote = F, sep = "\t", row.names = FALSE)
...
write.table(self.prediction.mat, file = "./Output/3/VAEN_GDSC.A.pred_GDSC.txt", quote = F, sep = "\t", row.names = FALSE)
#####
...
write.table(self.pred.mat, file = paste("./Output/3/VAEN_GDSC.A.pred_GDSC.full.txt", sep = ""), quote = F, sep = "\t", row.names = FALSE)
