...
class AutoEncoder(nn.Module):
    def __init__(self, 
        ...
        self.encoder = nn.Sequential(
            nn.Linear(feature_r1 + feature_r2[1] + feature_r3[1] + feature_r4, 10240),
        ...
        self.decoder = nn.Sequential(
            nn.Linear(feature_p1 + feature_r1 + feature_p2[1] + feature_p3[1] + feature_p4, 10240),
            nn.ReLU(inplace=True),
            nn.Dropout(0.2),
    ...
    def forward(self, x1, x2, x3, x4, drug_edge):
        en1 = x1
        ...
        diease_feature = torch.cat([de0, de1, de2, de3, de4], dim=1)
