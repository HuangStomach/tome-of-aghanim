...
models_info = joblib.load('./Output/2/ccle_nn_models_info.joblib')
...
for drug in models_info.keys():
    ...
    model = K.models.load_model('./Output/2/ccle_models/{}.h5'.format(drug), custom_objects={'r2': r2})
...
tcga_pred_df.to_csv('./Output/3/ccle_nn_pred_tcga.csv', index=False)
...
ccle_pred_df.to_csv('./Output/3/ccle_nn_pred_ccle.csv', index=False)
